...
Occasionally, you may find the need to install additional third-party packages. As a concrete example, suppose I need to perform Markov chain Monte Carlo via the [PyMC](https://www.pymc.io/welcome.html) package.
